...
const ROUTES = {
  '/branding': {
    title: 'Agence Branding au Maroc — Logo & Identité | Link Agency',
    description: "Agence branding au Maroc : logo, charte graphique, plateforme de marque, refonte d'identité. PME, ETI et grands comptes. Casablanca, Rabat, Marrakech.",
  ...
  '/content-digital': {
    title: 'Content Digital au Maroc — Création de Contenu | Link Agency',
  ...
  '/conseil-strategique': {
    ...
    description: "Conseil stratégique marketing au Maroc : audit, plan, roadmap d'activation. PME, ETI et filiales étrangères. 11 ans d'expérience.",
  ...
  '/creation-site-web-agadir': {
    ...
    description: "Agence web à Agadir : site internet, e-commerce, plateforme sur-mesure. PME de la région Souss-Massa. Devis 48h, mobile-first, SEO local.",
    h1: 'Création de site web à Agadir',
  },
  '/creation-site-web-tanger': {
    title: 'Création de Site Web à Tanger | Agence Web | Link Agency',
    description: "Agence web à Tanger : site internet, e-commerce, plateforme sur-mesure. PME de la région Tanger-Tétouan. Devis 48h, mobile-first, SEO local.",
  ...
  '/creation-site-web-casablanca': {
    ...
    description: "Agence web à Casablanca : site internet, e-commerce, plateforme sur-mesure. PME, ETI, CFC, filiales. Devis 48h, mobile-first, SEO local.",
  ...
  '/creation-site-web-marrakech': {
    ...
    description: "Agence web à Marrakech : sites pour hôtels, riads, restaurants, immobilier de prestige, marques lifestyle. Design premium, mobile-first.",
  ...
  '/blog': {
    title: 'Blog Marketing, Branding & Communication | Link Agency',
  ...
  '/contact': {
    title: 'Contact — Link Agency | WhatsApp ou devis gratuit',
