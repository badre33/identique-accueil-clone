...
const AgenceWebCasablanca = () => {
  ...
  const schema = {
    ...
    "@graph": [
      ...
      generateWebPageSchema(
        ...
        "Agence web à Casablanca : création de site internet, e-commerce et plateformes sur-mesure pour entreprises de la région Grand Casablanca.",
        "https://linkagency.ma/creation-site-web-casablanca"
      ),
      generateBreadcrumbSchema([
        { name: "Accueil", url: "https://linkagency.ma/" },
        { name: "Création site web Casablanca", url: "https://linkagency.ma/creation-site-web-casablanca" },
      ]),
  ...
  const handleContact = () => {
    const message = "Bonjour, je souhaite créer un site web à Casablanca avec Link Agency. Pourrions-nous échanger sur mon projet ?";
  ...
  return (
    <div className="min-h-screen bg-white pt-16 sm:pt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-slate-100 via-blue-50 to-gray-50 rounded-2xl flex items-center justify-center">
                <Globe className="w-48 h-48 text-slate-700/40" strokeWidth={1} />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 lg:px-12 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-semibold text-black mb-4">Secteurs accompagnés à Casablanca et dans le Grand Casablanca</h2>
          <p className="text-gray-600 mb-12 max-w-2xl">Nous concevons des sites web adaptés aux codes et aux usages de votre secteur, en intégrant les spécificités du marché local Casablanca.</p>
      ...
      <section className="py-20 px-6 lg:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              { n: "1", title: "Discovery & cadrage", desc: "Brief approfondi, analyse de votre secteur, étude de la concurrence locale Casablanca, définition du périmètre fonctionnel et des KPIs." },
              ...
              { n: "4", title: "Développement & SEO", desc: "Code propre, performant, optimisé SEO local Casablanca. Tests cross-browser, mobile-first, accessibilité." },
      ...
      <section className="py-20 px-6 lg:px-12 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-semibold text-black mb-12">Questions fréquentes — création de site web à Casablanca</h2>
...
export default AgenceWebCasablanca;
