...
const AgenceWebRabat = () => {
  const faqs = [
    { question: "Comment se cadre une mission de site web à Rabat ?", answer: "Chaque mission est cadrée selon le périmètre : site vitrine, site e-commerce ou plateforme métier sur mesure. Le premier échange avec le fondateur permet de qualifier le besoin et de structurer une proposition adaptée." },
    { question: "Quels délais pour créer un site web à Rabat ?", answer: "Le calendrier dépend du périmètre fonctionnel, du volume de contenu et des validations. Il est défini pendant le cadrage puis formalisé dans la proposition." },
  ...
  const services = [
    { icon: <Globe className="w-7 h-7" />, title: "Site vitrine professionnel", desc: "5-10 pages, design moderne, optimisé pour la conversion. Idéal pour les PME et services à Rabat.", from: "Sur cadrage" },
    ...
    { icon: <Search className="w-7 h-7" />, title: "SEO local Rabat", desc: "Référencement Google Maps, Google Business Profile, contenu géolocalisé, backlinks Rabat-Salé-Kénitra." },
  ];
  ...
  return (
    <div className="min-h-screen bg-white pt-16 sm:pt-20">
      <SEOHead
        ...
        description="Agence web à Rabat : création de site internet, e-commerce et plateforme sur mesure. Cadrage stratégique, mobile-first et SEO local."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg lg:text-xl text-gray-700 leading-relaxed mb-8 font-light">
                Sites vitrines, e-commerce et plateformes sur mesure pour les entreprises à Rabat et dans la région Rabat-Salé-Kénitra. Design mobile-first, conversion et SEO local sous un même pilotage.
              </p>
