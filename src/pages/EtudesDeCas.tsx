...
const cases = [
  ...
  { client: "YES par Granex", status: "Projet cadré", sector: "Agroalimentaire", title: "Préparer l’entrée en marché d’une nouvelle marque", challenge: "Faire tenir ensemble positionnement, identité, packaging et activation commerciale avant le lancement d’une marque de graines au Maroc.", approach: "Travail de cadrage et de préparation du dispositif de marque. Le projet est présenté comme une démarche préparée, et non comme un déploiement finalisé.", services: [["Branding", "/branding"], ["Conseil stratégique", "/conseil-strategique"]] },
      ...
      <main>
        <section className="border-b border-black/15 px-5 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-36">
          <div className="mx-auto max-w-[1440px]">
            <p className="editorial-eyebrow text-black/45">Missions sélectionnées · 01–07</p>
