...
const cases = [
  {
    ...
    title: "Sélectionnés sur appel d'offres ouvert face à des agences premium",
    challenge: "Mission de communication digitale pour la filiale Maroc d'un grand groupe international. Appel d'offres ouvert opposant plusieurs agences premium sur un périmètre comparable (stratégie, production éditoriale, reporting).",
    approach: "Proposition resserrée : un fondateur senior pilote chaque dossier, pas de comité ni de chargé de compte intermédiaire. Démonstration de méthode et d'expertise sectorielle lors du pitch. Cadrage transparent, onboarding 7 jours.",
    kpis: [
      { icon: Target, label: "Appel d'offres", value: "Gagné" },
      { icon: TrendingUp, label: "Méthode validée", value: "Pitch" },
