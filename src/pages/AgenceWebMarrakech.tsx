...
const AgenceWebMarrakech = () => {
  const faqs = [
    { question: "Combien coûte la création d'un site web à Marrakech ?", answer: "Le prix d'un site internet à Marrakech dépend du périmètre : site vitrine PME (5-7 pages) à partir de 15 000 MAD, site e-commerce à partir de 30 000 MAD, plateforme sur-mesure à partir de 60 000 MAD. Devis transparent sous 48h, sans engagement." },
  ...
  const services = [
    { icon: <Globe className="w-7 h-7" />, title: "Site vitrine professionnel", desc: "5-10 pages, design moderne, optimisé pour la conversion. Idéal pour les PME et services à Marrakech.", from: "À partir de 15 000 MAD" },
    ...
    { icon: <Search className="w-7 h-7" />, title: "SEO local Marrakech", desc: "Référencement Google Maps, Google Business Profile, contenu géolocalisé, backlinks Marrakech-Safi.", from: "À partir de 5 000 MAD/mois" },
  ];
