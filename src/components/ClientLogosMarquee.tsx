...
const logos: LogoEntry[] = [
  ...
  // Comptes accompagnés par l'équipe — wordmarks (issus du dossier technique)
  { name: "Attijari Wafabank", src: "/brands/attijari-wafabank.svg" },
  { name: "Wafasalaf", src: "/brands/wafasalaf.svg" },
  { name: "Wafa Assurance", src: "/brands/wafa-assurance.svg" },
  { name: "Fondation Al Mada", src: "/brands/fondation-al-mada.svg" },
  { name: "Saham", src: "/brands/saham.svg" },
  { name: "Allianz", src: "/brands/allianz.svg" },
  { name: "Arab Bank", src: "/brands/arab-bank.svg" },
  { name: "Orange Maroc", src: "/brands/orange-maroc.svg" },
  { name: "OCP", src: "/brands/ocp.svg" },
  { name: "OCP Africa", src: "/brands/ocp-africa.svg" },
  { name: "Safran", src: "/brands/safran.svg" },
  { name: "Honda Motor", src: "/brands/honda-motor.svg" },
  { name: "Ford", src: "/brands/ford.svg" },
  { name: "Pharma 5", src: "/brands/pharma-5.svg" },
  { name: "Mutandis Group", src: "/brands/mutandis.svg" },
  { name: "Aiguebelle", src: "/brands/aiguebelle.svg" },
  { name: "Barid Al-Maghrib", src: "/brands/barid-al-maghrib.svg" },
  { name: "Al Barid Bank", src: "/brands/al-barid-bank.svg" },
  { name: "Aéroports du Maroc", src: "/brands/aeroports-du-maroc.svg" },
  { name: "AMDIE", src: "/brands/amdie.svg" },
  { name: "CDG", src: "/brands/cdg.svg" },
  { name: "Dekra", src: "/brands/dekra.svg" },
  { name: "Brainlyne", src: "/brands/brainlyne.svg" },
];
