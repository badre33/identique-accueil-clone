    ...
    >
      ...
      <div className="container-max relative z-10">
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Élément décoratif */}
                <div className="absolute -top-2 -right-2 w-24 h-24 bg-gradient-to-br from-white/50 to-purple-100/50 rounded-full blur-xl group-hover:scale-150 group-focus-within:scale-150 transition-transform duration-700" aria-hidden="true"></div>
              </article>
            );
          })}
        </div>
        ...
        <section className="text-center mt-20 animate-fade-in-up" style={{ animationDelay: '0.7s' }} aria-label="Appel à l'action">
          <div className="bg-gradient-to-r from-purple-50 via-pink-50 to-purple-50 rounded-3xl p-8 lg:p-12 max-w-4xl mx-auto border border-purple-100">
