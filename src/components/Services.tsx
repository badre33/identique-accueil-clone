          ...
          {services.map((service, index) => {
            ...
            return (
              <Link 
                key={index} 
                to={service.link}
                className="interactive-card group relative bg-white border border-neutral-200 rounded-3xl p-8 lg:p-10 hover:shadow-2xl hover:shadow-black/10 hover:border-neutral-300 overflow-hidden animate-fade-in-up"
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <h3 className="text-2xl lg:text-3xl font-light text-black group-hover:text-neutral-700 transition-colors">
                      {service.title}
                    </h3>
                    <span className="text-4xl font-light text-neutral-200 group-hover:text-neutral-300 transition-colors">
                      0{index + 1}
                    </span>
                  </div>
