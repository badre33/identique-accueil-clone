...
const timelineEvents: TimelineEvent[] = [
  {
    ...
    year: '2019',
    title: 'La Rencontre',
    description: 'Badreddine et Ayman se rencontrent et identifient une vision commune.',
    detailedDescription: 'Dans un environnement académique stimulant, deux profils complémentaires se rencontrent. Cette première collaboration révèle une forte cohérence entre vision stratégique et exigence créative.',
    icon: Users,
  ...
  },
  {
    ...
    description: 'Première collaboration majeure avec une marque parisienne en structuration.',
    detailedDescription: 'Le duo signe une refonte complète d\'identité pour une marque tech. Ce mandat établit leur crédibilité et pose les bases de leur approche méthodologique.',
    icon: Lightbulb,
  ...
  },
  {
    ...
    detailedDescription: 'Développement d\'une méthodologie propriétaire combinant rigueur stratégique et design thinking pour des résultats plus lisibles et mieux pilotés.',
    icon: Award,
  ...
  },
  {
    ...
    description: 'Création officielle de Link Agency avec une vision claire et structurée.',
    detailedDescription: 'Création officielle de Link Agency avec une mission claire : concevoir des dispositifs de marque alliant rigueur stratégique et exigence créative.',
    icon: Rocket,
  ...
  },
  {
    ...
    description: 'Développement du portefeuille clients et renforcement de la reconnaissance du studio.',
    detailedDescription: 'Une phase d\'expansion marquée par l\'accélération du portefeuille, l\'ouverture vers les grands comptes et une reconnaissance croissante au-delà du marché local.',
    icon: Calendar,
